...
set_property -dict { PACKAGE_PIN U8    IOSTANDARD LVCMOS18 } [get_ports { m }]; #IO_25_34 Sch=sw[9]
set_property -dict { PACKAGE_PIN R16   IOSTANDARD LVCMOS33 } [get_ports { s[0] }]; #IO_L15P_T2_DQS_RDWR_B_14 Sch=sw[10]
set_property -dict { PACKAGE_PIN T13   IOSTANDARD LVCMOS33 } [get_ports { s[1] }]; #IO_L23P_T3_A03_D19_14 Sch=sw[11]
